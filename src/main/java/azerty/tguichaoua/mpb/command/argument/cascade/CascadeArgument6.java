...
public abstract class CascadeArgument6<A, B, C, D, E, F> implements CommandArgument<Sextet<A, B, C, D, E, F>> {
	public final <G> CascadeArgument7<A, B, C, D, E, F, G> cascade(
			@NotNull final CascadeFunction<F, G> g
	) {
		return new Cascade7_6<>(this, g);
	}
	...
	public final <G, H> CascadeArgument8<A, B, C, D, E, F, G, H> cascade(
		...
		return new Cascade8_6<>(this, g, h);
	}
	...
	public final <G, H, I> CascadeArgument9<A, B, C, D, E, F, G, H, I> cascade(
		...
		return new Cascade9_6<>(this, g, h, i);
	}
	...
	public final <G, H, I, J> CascadeArgument10<A, B, C, D, E, F, G, H, I, J> cascade(
		...
		return new Cascade10_6<>(this, g, h, i, j);
	}
...
@RequiredArgsConstructor final class Cascade6_1<A, B, C, D, E, F> extends CascadeArgument6<A, B, C, D, E, F> {
...
@RequiredArgsConstructor final class Cascade6_2<A, B, C, D, E, F> extends CascadeArgument6<A, B, C, D, E, F> {
...
@RequiredArgsConstructor final class Cascade6_3<A, B, C, D, E, F> extends CascadeArgument6<A, B, C, D, E, F> {
...
@RequiredArgsConstructor final class Cascade6_4<A, B, C, D, E, F> extends CascadeArgument6<A, B, C, D, E, F> {
...
@RequiredArgsConstructor final class Cascade6_5<A, B, C, D, E, F> extends CascadeArgument6<A, B, C, D, E, F> {
