...
public abstract class CascadeArgument10<A, B, C, D, E, F, G, H, I, J> implements CommandArgument<Decade<A, B, C, D, E, F, G, H, I, J>> {
	public final CommandArgument<J> lastValue() {
		return this.then(Decade::getValue9);
	}
}

@RequiredArgsConstructor final class Cascade10_1<A, B, C, D, E, F, G, H, I, J> extends CascadeArgument10<A, B, C, D, E, F, G, H, I, J> {
...
@RequiredArgsConstructor final class Cascade10_2<A, B, C, D, E, F, G, H, I, J> extends CascadeArgument10<A, B, C, D, E, F, G, H, I, J> {
...
@RequiredArgsConstructor final class Cascade10_3<A, B, C, D, E, F, G, H, I, J> extends CascadeArgument10<A, B, C, D, E, F, G, H, I, J> {
...
@RequiredArgsConstructor final class Cascade10_4<A, B, C, D, E, F, G, H, I, J> extends CascadeArgument10<A, B, C, D, E, F, G, H, I, J> {
...
@RequiredArgsConstructor final class Cascade10_5<A, B, C, D, E, F, G, H, I, J> extends CascadeArgument10<A, B, C, D, E, F, G, H, I, J> {
...
@RequiredArgsConstructor final class Cascade10_6<A, B, C, D, E, F, G, H, I, J> extends CascadeArgument10<A, B, C, D, E, F, G, H, I, J> {
...
@RequiredArgsConstructor final class Cascade10_7<A, B, C, D, E, F, G, H, I, J> extends CascadeArgument10<A, B, C, D, E, F, G, H, I, J> {
...
@RequiredArgsConstructor final class Cascade10_8<A, B, C, D, E, F, G, H, I, J> extends CascadeArgument10<A, B, C, D, E, F, G, H, I, J> {
...
@RequiredArgsConstructor final class Cascade10_9<A, B, C, D, E, F, G, H, I, J> extends CascadeArgument10<A, B, C, D, E, F, G, H, I, J> {
	private final @NotNull CascadeArgument9<A, B, C, D, E, F, G, H, I> ABCDEFGHI;
	private final @NotNull CascadeFunction<I, J> toJ;

	@Override
	public Decade<A, B, C, D, E, F, G, H, I, J> parse(@NotNull final CommandExecution execution) throws CommandException {
		final Ennead<A, B, C, D, E, F, G, H, I> abcdefghi = execution.get(ABCDEFGHI);
		final J j = execution.get(toJ.apply(abcdefghi.getValue8()));
		return abcdefghi.add(j);
	}
	...
	public @NotNull Collection<String> complete(@NotNull final CommandExecution execution) throws CommandException {
		...
		execution.checkpoint();
		complete = ABCDEFGHI.complete(execution);
		if (execution.remains() == 0) return complete;
		execution.restore();

		final CommandArgument<J> J = toJ.apply(execution.get(ABCDEFGHI).getValue8());
		return J.complete(execution);
	}
}
