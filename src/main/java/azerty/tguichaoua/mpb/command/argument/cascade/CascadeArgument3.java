...
public abstract class CascadeArgument3<A, B, C> implements CommandArgument<Triplet<A, B, C>> {
	public final <D> CascadeArgument4<A, B, C, D> cascade(
			@NotNull final CascadeFunction<C, D> d
	) {
		return new Cascade4_3<>(this, d);
	}
	...
	public final <D, E> CascadeArgument5<A, B, C, D, E> cascade(
		...
		return new Cascade5_3<>(this, d, e);
	}
	...
	public final <D, E, F> CascadeArgument6<A, B, C, D, E, F> cascade(
		...
		return new Cascade6_3<>(this, d, e, f);
	}
	...
	public final <D, E, F, G> CascadeArgument7<A, B, C, D, E, F, G> cascade(
		...
		return new Cascade7_3<>(this, d, e, f, g);
	}
	...
	public final <D, E, F, G, H> CascadeArgument8<A, B, C, D, E, F, G, H> cascade(
		...
		return new Cascade8_3<>(this, d, e, f, g, h);
	}
	...
	public final <D, E, F, G, H, I> CascadeArgument9<A, B, C, D, E, F, G, H, I> cascade(
		...
		return new Cascade9_3<>(this, d, e, f, g, h, i);
	}
	...
	public final <D, E, F, G, H, I, J> CascadeArgument10<A, B, C, D, E, F, G, H, I, J> cascade(
		...
		return new Cascade10_3<>(this, d, e, f, g, h, i, j);
	}
...
@RequiredArgsConstructor final class Cascade3_1<A, B, C> extends CascadeArgument3<A, B, C> {
...
@RequiredArgsConstructor final class Cascade3_2<A, B, C> extends CascadeArgument3<A, B, C> {
